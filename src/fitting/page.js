...
class Page {
	...
	create(template) {
		...
		let clone = document.importNode(this.pageTemplate.content, true); //importNode() method creates a copy of a Node or DocumentFragment from another document, to be inserted into the current document later.
		let page, index;
		...
		area.style.columnGap = "calc(var(--pagedjs-margin-right) + var(--pagedjs-margin-left))"; //column gap è la somma tra le colonne
	...
	index(pgnum) {
		...
		//Importante per classificare le pagine
